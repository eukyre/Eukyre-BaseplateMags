...
class EukyreBaseplateMags {
    Instance = new WTTInstanceManager_1.WTTInstanceManager();
    version;
    modName = "Eukyre's Baseplate Mags";
    //#region CustomBosses
    ...
    displayCreditBanner() {
        this.colorLog(`[${this.modName}] Developers:  -  ProbablyEukyre  Code Framework: GroovypenguinX - "We have MoxoPixel at home:"`, "green");
    }
}
module.exports = { mod: new EukyreBaseplateMags() };
